...
--   UPDATE app_config SET value='<RUNTIME_ONLY — 실값은 커밋하지 않는다>' WHERE group_name='oauth' AND key='apple_key_id';
--   UPDATE app_config SET value='<RUNTIME_ONLY — 실값은 커밋하지 않는다>' WHERE group_name='oauth' AND key='apple_team_id';
--   UPDATE app_config SET value='<RUNTIME_ONLY — 실값은 커밋하지 않는다>' WHERE group_name='oauth' AND key='apple_services_id';
