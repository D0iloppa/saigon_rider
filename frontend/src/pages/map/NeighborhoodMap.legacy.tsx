...
import styles from './NeighborhoodMap.legacy.module.css';

type Tab = 'listings' | 'feed';
const AD_EVERY = 4;

/**
 * [LEGACY] 동네지도 v1 (SGR-287) — SaigonMapV2 동 선택 → 경계 안 매물/피드 리스트.
 * OSM 타일 풀스크린 + 드래거블 시트 v2로 교체됨. 비교/롤백용 보존(라우트 미연결).
 */
export default function NeighborhoodMapLegacy() {
