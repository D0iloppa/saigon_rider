...
- **동네지도 업체 UX 4패키지 완료 (2026-07-12)** — 당근 레퍼런스 기반 대표 피드백 반영, 코드·시각검증 DONE·커밋 5건.
  ...
  - **잔여**: ①후기쓰기 제품 결정(focusedBiz 기반 직배선 여부) ②운영 배포 시 BFF 재시작+프론트 재빌드(신규 DB 마이그 없음) ③codebase-memory ADR·재인덱싱(세션 MCP 재단절).
