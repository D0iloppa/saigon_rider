  ...
  return (
    <div className={s.node}>
      ...
      <div className={`${s.rewardCard} ${node.is_claimed_free ? s.rewardCardClaimed : ''}`}>
        {node.is_claimed_free && (
          <span className={s.rewardCardClaimedBadge}>
      ...
      {premCode ? (
        ...
        <div className={`${s.rewardCard}`} style={{ opacity: .2 }}>
          <span className={s.rewardIcon}>
            <Lock size={18} strokeWidth={2} color="rgba(255,255,255,.6)" aria-hidden />
          </span>
        </div>
      )}
    </div>
    ...
    <div className={s.page}>
      ...
      <div className={s.header}>
        <div className={s.headerTop}>
          <button className={s.backBtn} onClick={() => navigate(-1)} aria-label={t('common.back')}>
        ...
        <div className={s.levelCard}>
          ...
          <div className={s.tierBadge}><StarIcon size={11} /> {tier_label}</div>
        </div>
      </div>
