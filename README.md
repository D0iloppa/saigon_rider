...
승인된 업체용 `/biz/manage` 파트너 라운지는 운영·성과 탭에서 업체 전환, 정보·소식·가격표·매물·광고 관리, 후기 답글·신고, 광고 지원 접수와 7/14/30일 광고 성과를 제공한다. 소재 심사·계약·실제 노출은 별도 상태로 표시하며, `고객 행동`은 전화·단골·찜·후기 행동 합계다.
