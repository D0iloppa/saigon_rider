...
import { Banknote, Bike, Camera, Check, Gift, MessageSquare, Star, Wrench } from 'lucide-react';
...
export default function InfoRepairWrite() {
  ...
  return (
    <div className={sys.page}>
      ...
      <div
        className={`${sys.scroll} ${styles.scroll}`}
      ...
      >
        ...
        <div className={styles.fieldGroup}>
          <div className={styles.fieldLabel}>
            <Bike size={14} strokeWidth={2} className={styles.fieldIcon} />
            {t('info.repair.vehicleLabel')}
          </div>
          <input
        ...
        <div className={styles.fieldGroup}>
          <div className={styles.fieldLabel}>
            <Wrench size={14} strokeWidth={2} className={styles.fieldIcon} />
            {t('info.repair.serviceLabel')}
          </div>
          <select
        ...
        <div className={styles.fieldGroup}>
          <div className={styles.fieldLabel}>
            <Banknote size={14} strokeWidth={2} className={styles.fieldIcon} />
            {t('info.repair.priceLabel')}
          </div>
        ...
        <div className={styles.fieldGroup}>
          <div className={styles.fieldLabel}>
            <MessageSquare size={14} strokeWidth={2} className={styles.fieldIcon} />
            {t('info.repair.commentLabel')}
          </div>
          <textarea
        ...
        <div className={styles.fieldGroup}>
          <div className={styles.fieldLabel}>
            <Camera size={14} strokeWidth={2} className={styles.fieldIcon} />
            {t('info.repair.photoLabel')}
          </div>
          <button
            type="button"
        ...
        >
          <div className={`${styles.checkbox} ${isAnonymous ? styles.checkboxChecked : ''}`}>
            {isAnonymous && <Check size={13} strokeWidth={3} />}
          </div>
          <div>
        ...
        <div className={styles.gpBox}>
          <div className={styles.gpTitle}>
            ...
            {t('info.repair.gpEstimate')}
          </div>
          <div className={styles.gpRow}>
            <span>{t('info.repair.xpReviewRow')}</span>
            <span className={`${styles.gpAmount} num`}>+{rpReview} RP</span>
          </div>
          <div className={styles.gpRow}>
