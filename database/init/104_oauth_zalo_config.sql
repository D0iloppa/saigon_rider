...
--   UPDATE app_config SET value='<RUNTIME_ONLY — 실값은 커밋하지 않는다>' WHERE group_name='oauth' AND key='zalo_app_id';
--   UPDATE app_config SET value='<RUNTIME_ONLY — 실값은 커밋하지 않는다>' WHERE group_name='oauth' AND key='zalo_app_secret';
