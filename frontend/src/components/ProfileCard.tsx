...
import { MoreVertical, Building2, Coffee, Moon, Flame, MessageCircle, Heart, Send, Images } from 'lucide-react';
      ...
      >
        ...
        >
          {feedLoading ? (
            ...
            <StateBlock icon={Images} title={t('profile.emptyFeeds')} />
          ) : (
                ...
                <article key={p.id} className={styles.post}>
                  ...
                  <div className={styles.postBody}>
                    ...
                    <div className={styles.postActions}>
                      ...
                      >
                        <Flame size={15} /> <span className="num">{p.cheerCount}</span>
                      </button>
                      <button className={styles.actionBtn} onClick={() => openComments(p)}>
                        <MessageCircle size={15} /> <span className="num">{p.commentCount}</span>
                      </button>
                    </div>
                  </div>
                </article>
            ...
            <div className={styles.commentList}>
              {comments.map((c) => (
                <div key={c.id} className={styles.commentItem}>
                  ...
                  >
                    <Heart size={14} fill={c.iLiked ? 'currentColor' : 'none'} />
