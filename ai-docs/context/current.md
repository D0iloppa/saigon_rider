...
- **[기획] 비즈니스 파트너 — 비즈니스 계정 신설 (2026-07-10, SGR-312)** — **기획 확정 완료(D1~D6 전건 대표 승인) + 비즈니스 랜딩페이지 기획 포함(§8)**. SoT [`spec/business-partner-260710.md`](../spec/business-partner-260710.md): 계정 부착형 프로필 / 수동 심사 / 광고 [등록→심사→게시] / 지점 단위+group_id 선확보 / dev 광고 FK 이관 / 웹은 랜딩만(콘솔 없음). **다음 스레드: BP-1~BP-7 단위 구현 착수**(라우팅: 기계 작업 Sonnet, 랜딩 시각구현 Fable). 잔여 소결정 L1~L3(도메인·Zalo·프리런치 CTA)은 §8.
