...
import {
  Bell, Globe, Moon, MapPin, Pencil, UserRound, Ban, Lock, FileText,
  Info, Megaphone, CircleHelp, MessageCircle, ChevronRight,
} from 'lucide-react';
    ...
    <>
      ...
      <div className={styles.body}>
        ...
        <Section title={t('settings.sectionAccount')}>
          ...
          />
          <SettingsRow icon={<Lock size={18} />} label={t('settings.privacy')} arrow onClick={() => navigate('/settings/privacy')} />
          <SettingsRow icon={<FileText size={18} />} label={t('settings.terms')} arrow onClick={() => navigate('/settings/terms')} />
        </Section>

        <Section title={t('settings.sectionOther')}>
          <SettingsRow icon={<Info size={18} />} label={t('settings.appInfo')} value={appVersion || '...'} arrow onClick={showVersionInfo} />
          <SettingsRow icon={<Megaphone size={18} />} label={t('settings.notices')} arrow onClick={() => navigate('/notices')} />
          <SettingsRow icon={<CircleHelp size={18} />} label={t('settings.faq')} arrow onClick={() => navigate('/faq')} />
          <SettingsRow icon={<MessageCircle size={18} />} label={t('settings.support')} arrow onClick={() => navigate('/settings/support')} />
        </Section>
