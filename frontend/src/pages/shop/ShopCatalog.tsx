...
import { ArrowUpRight, Check, ChevronLeft, ChevronRight, Gift, ShoppingBag, Timer } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className={styles.featuredInfo}>
        ...
        <div className={styles.featuredTimer}>
          <Timer size={12} strokeWidth={2.5} aria-hidden /> {timer}
        </div>
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerBalance}>
          <div className={styles.balanceRow}>
            <RewardIcon type="GOLD" size={14} className={styles.balanceIcon} />
            <span className={styles.balanceGp}>
              {t('currency.gold')} {wallet.gold.toLocaleString()}
            </span>
          </div>
          <div className={styles.balanceRow}>
            <RewardIcon type="XP" size={14} className={styles.balanceIcon} />
      ...
      <div className={styles.body}>
        ...
        <button type="button" className={styles.couponEntry} onClick={() => navigate('/shop/coupons')}>
          <span className={styles.couponEntryLabel}>
        ...
        <div className={styles.chips}>
          {group === null ? (
            ...
            <>
              ...
              >
                <ChevronLeft size={13} strokeWidth={2.5} aria-hidden /> {t(GROUPS[group].i18nKey)}
              </button>
              <button
        ...
        {/* Item Grid */}
        {loading ? (
          <div className={styles.itemGrid} aria-hidden>
            {Array.from({ length: 4 }, (_, i) => (
              <div key={i} className={styles.skelCard}>
                <div className={sys.skelBar} style={{ width: 64, height: 64, borderRadius: 12, margin: '10px auto' }} />
          ...
          <StateBlock icon={ShoppingBag} title={t('shop.empty')} />
        ) : (
                ...
                {item.is_owned && (
                  <div className={styles.ownedOverlay}>
                    <span className={styles.ownedLabel}>
                      <Check size={11} strokeWidth={3} aria-hidden /> {t('shop.owned')}
                    </span>
                  </div>
                )}
        ...
        >
          ...
          <RewardIcon type="XP" size={52} className={styles.gachaBannerIcon} />
          ...
          <div className={styles.gachaBannerArrow}>
