...
import { Building2, Coffee, Moon, Camera, type LucideIcon } from 'lucide-react';
...
const RIDER_STYLES: { code: RiderStyle; icon: LucideIcon; titleKey: string; subKey: string }[] = [
  { code: 'commuter', icon: Building2, titleKey: 'profileSetup.styleCommuterTitle', subKey: 'profileSetup.styleCommuterSub' },
  { code: 'cafe_hunter', icon: Coffee, titleKey: 'profileSetup.styleCafeHunterTitle', subKey: 'profileSetup.styleCafeHunterSub' },
  { code: 'night_rider', icon: Moon, titleKey: 'profileSetup.styleNightRiderTitle', subKey: 'profileSetup.styleNightRiderSub' },
];
          ...
          <div className={styles.styleList}>
            {RIDER_STYLES.map((s) => (
              <button
                ...
                type="button"
              >
                <span className={styles.styleIcon}><s.icon size={22} strokeWidth={2} /></span>
